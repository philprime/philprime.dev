...
In [Part I](/blog/2026/02/09/building-type-safe-metrics-api-in-swift-part-i/), we built the foundation of our Metrics API: type-safe methods with optional parameters and flexible unit types.
...
The initial approach was using [extension with a generic where-clause](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/generics/#Extensions-with-a-Generic-Where-Clause) like `extension <TYPE> where <CONDITION>` to add logic to a `TYPE` only if a `CONDITION` on the typing is fulfilled.
...
![Compiler error when multiple conformances to same protocol](/assets/blog/2026-02-09-building-type-safe-metrics-api-in-swift/multi-conformance.webp)
...
![Swift 5 warning for unknown cases](/assets/blog/2026-02-09-building-type-safe-metrics-api-in-swift/switch-unknown-values-swift-5.webp)
