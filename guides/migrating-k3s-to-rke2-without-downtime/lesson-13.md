...
2. Configure dual-stack vSwitch networking with `10.1.1.3` and `fd00:1::3` ([Lesson 6](/guides/migrating-k3s-to-rke2-without-downtime/lesson-6))
...
node3   Ready    control-plane,etcd,master   2m    v1.31.x+rke2r1   10.1.1.3,fd00:1::3
node4   Ready    control-plane,etcd,master   3h    v1.31.x+rke2r1   10.1.1.4,fd00:1::4
```
