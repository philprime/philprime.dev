...
guide_section_abstract: >
  Install Rocky Linux 9 on the first node, configure Hetzner networking, set up firewall rules, and bootstrap the
  initial RKE2 control plane with Cilium CNI.
guide_section_cta: >
...
This section covers the preparation of the new cluster environment. You will install Rocky Linux 9 on the first new
node (Node 4), configure the Hetzner vSwitch networking, set up firewalld for Kubernetes, and bootstrap the initial
RKE2 control plane with Cilium as the CNI plugin.

## Topics Covered

- Installing and configuring Rocky Linux 9 for Kubernetes
